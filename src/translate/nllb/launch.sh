...
do
    ...
    --dataset_path /home/pgajo/checkthat24/checkthat24_DIT/data/train_gold/train_gold_sentences_fixed.json \
    --train_dir /home/pgajo/checkthat24/checkthat24_DIT/data/train_sent_mt_fixed \
